...
const COMPOUNDS = [
  { name: 'Gabapentin', smiles: gabapentin, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Pregabalin', smiles: pregabalin, start: 'C', desc: 'from methane' },
  { name: 'Amitriptyline', smiles: amitriptyline, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Duloxetine', smiles: duloxetine, start: 'c1ccc2ccccc2c1', desc: 'from naphthalene' },
  { name: 'Carbamazepine', smiles: carbamazepine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Valproic Acid', smiles: valproicAcid, start: 'C', desc: 'from methane' },
];
...
describe('Adjuvant Analgesics - Gradient Descent 5% Loss', () => {
  const results = {};
