...
const COMPOUNDS = [
  { name: 'Cortisone', smiles: cortisone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Hydrocortisone', smiles: hydrocortisone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Prednisone', smiles: prednisone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Prednisolone', smiles: prednisolone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Dexamethasone', smiles: dexamethasone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Methylprednisolone', smiles: methylprednisolone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Triamcinolone', smiles: triamcinolone, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Budesonide', smiles: budesonide, start: 'C1CCCCC1', desc: 'from cyclohexane' },
];
...
describe('Steroids - Gradient Descent 5% Loss', () => {
  const results = {};
