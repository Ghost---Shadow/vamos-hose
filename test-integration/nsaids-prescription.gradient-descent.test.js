...
const COMPOUNDS = [
  { name: 'Celecoxib', smiles: celecoxib, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Meloxicam', smiles: meloxicam, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Piroxicam', smiles: piroxicam, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Etodolac', smiles: etodolac, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Ketorolac', smiles: ketorolac, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Nabumetone', smiles: nabumetone, start: 'c1ccc2ccccc2c1', desc: 'from naphthalene' },
  { name: 'Oxaprozin', smiles: oxaprozin, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Prescription NSAIDs - Gradient Descent 5% Loss', () => {
  const results = {};
