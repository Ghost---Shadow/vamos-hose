...
const COMPOUNDS = [
  { name: 'Met-Enkephalin', smiles: metEnkephalin, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Leu-Enkephalin', smiles: leuEnkephalin, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Endomorphin-1', smiles: endomorphin1, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Endomorphin-2', smiles: endomorphin2, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Endogenous Opioids - Gradient Descent 5% Loss', () => {
  const results = {};
