...
const COMPOUNDS = [
  { name: 'Lidocaine', smiles: lidocaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Bupivacaine', smiles: bupivacaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Ropivacaine', smiles: ropivacaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Mepivacaine', smiles: mepivacaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Prilocaine', smiles: prilocaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Benzocaine', smiles: benzocaine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Procaine', smiles: procaine, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Local Anesthetics - Gradient Descent 5% Loss', () => {
  const results = {};
