...
const COMPOUNDS = [
  { name: 'Morphine', smiles: morphine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Codeine', smiles: codeine, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Oxycodone', smiles: oxycodone, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Hydrocodone', smiles: hydrocodone, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Fentanyl', smiles: fentanyl, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Tramadol', smiles: tramadol, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Methadone', smiles: methadone, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Opioids - Gradient Descent 5% Loss', () => {
  const results = {};
