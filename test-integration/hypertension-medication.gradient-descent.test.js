...
const COMPOUNDS = [
  { name: 'Telmisartan', smiles: telmisartan, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Losartan', smiles: losartan, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Valsartan', smiles: valsartan, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Irbesartan', smiles: irbesartan, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Hypertension Medication - Gradient Descent 5% Loss', () => {
  const results = {};
