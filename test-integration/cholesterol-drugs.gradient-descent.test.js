...
const COMPOUNDS = [
  { name: 'Atorvastatin', smiles: atorvastatin, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Simvastatin', smiles: simvastatin, start: 'C1CCCCC1', desc: 'from cyclohexane' },
  { name: 'Rosuvastatin', smiles: rosuvastatin, start: 'c1nccnc1', desc: 'from pyrimidine' },
  { name: 'Fenofibrate', smiles: fenofibrate, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Gemfibrozil', smiles: gemfibrozil, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Cholesterol', smiles: cholesterol, start: 'C1CCCCC1', desc: 'from cyclohexane' },
];
...
describe('Cholesterol Drugs - Gradient Descent 5% Loss', () => {
  const results = {};
