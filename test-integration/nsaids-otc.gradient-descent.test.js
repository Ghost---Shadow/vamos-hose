...
const COMPOUNDS = [
  { name: 'Aspirin', smiles: aspirin, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Ibuprofen', smiles: ibuprofen, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Naproxen', smiles: naproxen, start: 'c1ccc2ccccc2c1', desc: 'from naphthalene' },
  { name: 'Ketoprofen', smiles: ketoprofen, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Diclofenac', smiles: diclofenac, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('OTC NSAIDs - Gradient Descent 5% Loss', () => {
  const results = {};
