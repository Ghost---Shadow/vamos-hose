...
const COMPOUNDS = [
  { name: 'Acetaminophen', smiles: acetaminophen, start: 'c1ccccc1', desc: 'from benzene' },
  { name: 'Phenacetin', smiles: phenacetin, start: 'c1ccccc1', desc: 'from benzene' },
];
...
describe('Acetaminophen and Related - Gradient Descent 5% Loss', () => {
  const results = {};
